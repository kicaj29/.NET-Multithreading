...
namespace AsyncLocalVsThreadLocal
{
    class Program
    {
        ...
        static async Task AsyncMethodB(string expectedValue)
        {
            ...
            Console.WriteLine("   Expected '{0}', AsyncLocal value is '{1}', ThreadLocal value is '{2}', ThreadId: '{3}'",
                              expectedValue, _asyncLocalString.Value, _threadLocalString.Value, Thread.CurrentThread.ManagedThreadId);
            await Task.Delay(100);
            Console.WriteLine("Exiting AsyncMethodB.");
            Console.WriteLine("   Expected '{0}', got '{1}', ThreadLocal value is '{2}', ThreadId: '{3}'",
                              expectedValue, _asyncLocalString.Value, _threadLocalString.Value, Thread.CurrentThread.ManagedThreadId);
        }
